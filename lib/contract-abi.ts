export const PREDICTION_MARKET_ABI = [
  ...
  {
    "inputs": [
      {"internalType": "enum PredictionMarket.Outcome", "name": "_outcome", "type": "uint8"},
      {"internalType": "uint256", "name": "_amountTokenToBuy", "type": "uint256"}
    ],
  ...
  },
  {
    "inputs": [
      {"internalType": "enum PredictionMarket.Outcome", "name": "_outcome", "type": "uint8"},
      {"internalType": "uint256", "name": "_tradingAmount", "type": "uint256"}
    ],
  ...
  },
  {
    ...
    "outputs": [
      ...
      {"internalType": "uint256", "name": "initialTokenValue", "type": "uint256"},
      {"internalType": "uint256", "name": "yesTokenReserve", "type": "uint256"},
      {"internalType": "uint256", "name": "noTokenReserve", "type": "uint256"},
      ...
      {"internalType": "address", "name": "winningToken", "type": "address"},
      {"internalType": "uint256", "name": "ethCollateral", "type": "uint256"},
      {"internalType": "uint256", "name": "lpTradingRevenue", "type": "uint256"},
      {"internalType": "address", "name": "predictionMarketOwner", "type": "address"},
      {"internalType": "uint256", "name": "initialProbability", "type": "uint256"},
      {"internalType": "uint256", "name": "percentageLocked", "type": "uint256"}
    ],
    "stateMutability": "view",
    "type": "function"
  },
  ...
  {
    "inputs": [{"internalType": "enum PredictionMarket.Outcome", "name": "_winningOutcome", "type": "uint8"}],
    "name": "report",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
  {
    ...
    "outputs": [{"internalType": "uint256", "name": "ethRedeemed", "type": "uint256"}],
    "stateMutability": "nonpayable",
    "type": "function"
  },
  {
  ...
  },
  {
    ...
    "inputs": [
      ...
      {"indexed": false, "internalType": "enum PredictionMarket.Outcome", "name": "winningOutcome", "type": "uint8"},
      {"indexed": false, "internalType": "address", "name": "winningToken", "type": "address"}
    ],
    "name": "MarketReported",
    "type": "event"
  },
  {
    ...
    "inputs": [
      ...
      {"indexed": false, "internalType": "uint256", "name": "totalEthToSend", "type": "uint256"}
    ],
    "name": "MarketResolved",
    "type": "event"
  },
