...
export function SellTokens() {
  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-lg shadow-lg p-6 mb-6">
      <h2 className="text-2xl font-bold text-gray-100 mb-4">Sell Tokens</h2>
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full px-6 py-3 bg-orange-600 text-white font-semibold rounded-lg hover:bg-orange-700 disabled:bg-gray-700 disabled:text-gray-500 disabled:cursor-not-allowed transition-colors"
        >
